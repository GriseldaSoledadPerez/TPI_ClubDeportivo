...
namespace Proyecto.Datos
{
...

    {
...

        {
            ...
            string T_clave = "Clave"; // se antepuso la T para indicarque vienen desde TECLADO
            ...
            while (correcto != true)
            {
                ...
                T_baseDatos = Microsoft.VisualBasic.Interaction.InputBox
               ("ingrese nombre de la base de datos", "DATOS DE INSTALACIÓN MySQL");
            ...
            *
            ...
            __________________ */
                ...
                T_servidor + " PUERTO= " + T_puerto + " BASE DE DATOS = " + T_baseDatos + " USUARIO: " +
            ...
            this.baseDatos = T_baseDatos; //"proyecto"
